...
```sh
go get -u 'github.com/defasdefbe/go-paperless-ngx@v0.1.0-alpha.1'
```
...
client.BulkEditObjects.New(context.TODO(), ...,
	// Override the header
...
if err != nil {
	...
	panic(err.Error()) // GET "/api/bulk_edit_objects/": 400 Bad Request { ... }
}
```
